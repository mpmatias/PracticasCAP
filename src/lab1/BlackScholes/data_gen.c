             ...
             )
{
    ...
    ts0             = (tfloat*)malloc( nopt * sizeof(tfloat));
    tx              = (tfloat*)malloc( nopt * sizeof(tfloat));
    tt              = (tfloat*)malloc( nopt * sizeof(tfloat));
    tvcall_compiler = (tfloat*)malloc( nopt * sizeof(tfloat));
    tvput_compiler  = (tfloat*)malloc( nopt * sizeof(tfloat));
    tvcall_mkl      = (tfloat*)malloc( nopt * sizeof(tfloat));
    tvput_mkl       = (tfloat*)malloc( nopt * sizeof(tfloat));
