...
static int allocate_data ( void )
{
	...
	u		= (float *) malloc ( 2*size*sizeof(float) ); //CGS
	v		= (float *) malloc ( 2*size*sizeof(float) ); //CGS
	u_prev		= (float *) malloc ( 2*size*sizeof(float) ); //CGS
	v_prev		= (float *) malloc ( 2*size*sizeof(float) ); //CGS
	dens		= (float *) malloc ( 2*size*sizeof(float) ); //CGS
	dens_prev	= (float *) malloc ( 2*size*sizeof(float) ); //CGS
